...
train_x, train_y, dev_x, dev_y = read_dataset()     #array
print ("data load finished")

with tf.Session() as sess:
    han = model.HAN(vocab_size=FLAGS.vocab_size,          #46960
                    num_classes=FLAGS.num_classes,        #5
                    embedding_size=FLAGS.embedding_size,  #200
                    hidden_size=FLAGS.hidden_size)        #50
    ...
    #train_summary_op = tf.summary.merg
    ...
    for batch in batches:
        # print (batch[0])
        x_batch, y_batch = zip(*batch)  # x_batch = 64 * 30 * 30  y_batch = 64 * 5
